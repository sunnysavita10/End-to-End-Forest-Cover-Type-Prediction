...
class Prediction_Data_validation:
    ...
    def manualRegexCreation(self):
        ...
        """
                                      ...
                                      On Failure: None
       """
        print("prediction file name should be CoverType_test_DataSet")
        regex = "['CoverType']+['\_'']+['test']+['\_'']+['DataSet']+\.csv"
        return regex
    ...
    def validateColumnLength(self,NumberofColumns):
        ...
        try:
            ...
            for file in onlyfiles :
                csv = pd.read_csv("Prediction_Batch_Files/" + file)
                if csv.shape[1] == NumberofColumns:
                    shutil.copy("Prediction_Batch_Files/" + file, "Prediction_Raw_Files_Validated/Good_Raw")
                    csv.to_csv("Prediction_Raw_Files_Validated/Good_Raw/" + file, index=None, header=True)
                else:
                    shutil.move("Prediction_Batch_Files/" + file, "Prediction_Raw_Files_Validated/Bad_Raw")
